...
{
    try {
        CalculatorRequest *sample = new CalculatorRequest();
    ...
    RTICdrTypeCode *type_code)
{
    ...
    programs = DDS_TypeCodeFactory_assert_programs_in_global_list(
        ...
        (DDS_TypeCode *) (RTIXCdrTypeCode *)&::rti::topic::dynamic_type< CalculatorRequest >::get().native()
        ,
        &programProperty,
    ...
    ::dds::core::policy::DataRepresentationId representation)
{
    ...
    try{
        ...
        (RTIXCdrTypeCode *)&::rti::topic::dynamic_type< CalculatorRequest >::get().native()
        ;
    ...
    unsigned int length)
{
    ...
    epd.programContext.endpointPluginData = &epd;
    plugin.typeCode = (struct RTICdrTypeCode *)
    (struct RTICdrTypeCode *)(RTIXCdrTypeCode *)&::rti::topic::dynamic_type< CalculatorRequest >::get().native()
    ;
    pd.programs = ::rti::topic::interpreter::get_cdr_serialization_programs<
    CalculatorRequest, 
    true, true, true>();
...
{ 
    ...
    */
    ...
    #else
    plugin->typeCode = (struct RTICdrTypeCode *) 
    &::rti::topic::dynamic_type< CalculatorRequest >::get().native();
    #endif
    ...
    static const char * TYPE_NAME = "CalculatorRequest";
...
{
    try {
        CalculatorResponse *sample = new CalculatorResponse();
        ::rti::topic::allocate_sample(*sample);
        return sample;
    } catch (...) {
        return NULL;
...
CalculatorResponsePluginSupport_copy_data(
    CalculatorResponse *dst,
    const CalculatorResponse *src)
{
    try {
        *dst = *src;
    } catch (...) {
    ...
    RTICdrTypeCode *type_code)
{
    ...
    programs = DDS_TypeCodeFactory_assert_programs_in_global_list(
        DDS_TypeCodeFactory_get_instance(),
        (DDS_TypeCode *) (RTIXCdrTypeCode *)&::rti::topic::dynamic_type< CalculatorResponse >::get().native()
        ,
        &programProperty,
        RTI_XCDR_PROGRAM_MASK_TYPEPLUGIN);
    ...
    void *containerPluginContext)
{
    try {
        ...
        epd = PRESTypePluginDefaultEndpointData_new(
            ...
            endpoint_info,
            (PRESTypePluginDefaultEndpointDataCreateSampleFunction)
            CalculatorResponsePluginSupport_create_data,
            (PRESTypePluginDefaultEndpointDataDestroySampleFunction)
            CalculatorResponsePluginSupport_destroy_data,
            NULL , NULL );
        ...
        if (endpoint_info->endpointKind == PRES_TYPEPLUGIN_ENDPOINT_WRITER) {
            serializedSampleMaxSize = CalculatorResponsePlugin_get_serialized_sample_max_size(
                epd,RTI_FALSE,RTI_CDR_ENCAPSULATION_ID_CDR_BE,0);
            PRESTypePluginDefaultEndpointData_setMaxSizeSerializedSample(epd, serializedSampleMaxSize);
            ...
            if (PRESTypePluginDefaultEndpointData_createWriterPool(
                ...
                endpoint_info,
                (PRESTypePluginGetSerializedSampleMaxSizeFunction)
                CalculatorResponsePlugin_get_serialized_sample_max_size, epd,
                (PRESTypePluginGetSerializedSampleSizeFunction)
                PRESTypePlugin_interpretedGetSerializedSampleSize,
                epd) == RTI_FALSE) {
                PRESTypePluginDefaultEndpointData_delete(epd);
...
CalculatorResponsePlugin_copy_sample(
    ...
    const CalculatorResponse *src)
{
    return CalculatorResponsePluginSupport_copy_data(dst,src);
}
    ...
    ::dds::core::policy::DataRepresentationId representation)
{
    ...
    try{
        ...
        epd.programContext.endpointPluginData = &epd;
        plugin.typeCode = (struct RTICdrTypeCode *)
        (RTIXCdrTypeCode *)&::rti::topic::dynamic_type< CalculatorResponse >::get().native()
        ;
        pd.programs = ::rti::topic::interpreter::get_cdr_serialization_programs<
        CalculatorResponse, 
        true, true, true>();
    ...
    unsigned int length)
{
    ...
    epd.programContext.endpointPluginData = &epd;
    plugin.typeCode = (struct RTICdrTypeCode *)
    (struct RTICdrTypeCode *)(RTIXCdrTypeCode *)&::rti::topic::dynamic_type< CalculatorResponse >::get().native()
    ;
    pd.programs = ::rti::topic::interpreter::get_cdr_serialization_programs<
    CalculatorResponse, 
    true, true, true>();
...
RTIBool CalculatorResponsePlugin_deserialize_key(
    PRESTypePluginEndpointData endpoint_data,
    CalculatorResponse **sample, 
    RTIBool * drop_sample,
    struct RTICdrStream *stream,
...
* Plug-in Installation Methods
* ------------------------------------------------------------------------ */
struct PRESTypePlugin *CalculatorResponsePlugin_new(void) 
{ 
    struct PRESTypePlugin *plugin = NULL;
    const struct PRESTypePluginVersion PLUGIN_VERSION = 
    PRES_TYPE_PLUGIN_VERSION_2_0;
    ...
    plugin->createSampleFnc =
    (PRESTypePluginCreateSampleFunction)
    CalculatorResponsePlugin_create_sample;
    plugin->destroySampleFnc =
    (PRESTypePluginDestroySampleFunction)
    CalculatorResponsePlugin_destroy_sample;
    ...
    plugin->getSampleFnc =
    (PRESTypePluginGetSampleFunction)
    CalculatorResponsePlugin_get_sample;
    plugin->returnSampleFnc =
    (PRESTypePluginReturnSampleFunction)
    CalculatorResponsePlugin_return_sample;
    plugin->getKeyKindFnc =
    (PRESTypePluginGetKeyKindFunction)
    CalculatorResponsePlugin_get_key_kind;
    ...
    */
    ...
    #else
    plugin->typeCode = (struct RTICdrTypeCode *) 
    &::rti::topic::dynamic_type< CalculatorResponse >::get().native();
    #endif
    plugin->languageKind = PRES_TYPEPLUGIN_CPPSTL_LANG;
    ...
    plugin->getBuffer = 
    (PRESTypePluginGetBufferFunction)
    CalculatorResponsePlugin_get_buffer;
    plugin->returnBuffer = 
    (PRESTypePluginReturnBufferFunction)
    CalculatorResponsePlugin_return_buffer;
    plugin->getBufferWithParams = NULL;
    plugin->returnBufferWithParams = NULL;
    plugin->getSerializedSampleSizeFnc =
    (PRESTypePluginGetSerializedSampleSizeFunction)
    ...
    static const char * TYPE_NAME = "CalculatorResponse";
    plugin->endpointTypeName = TYPE_NAME;
    plugin->isMetpType = RTI_FALSE;
    return plugin;
}
...
void
CalculatorResponsePlugin_delete(struct PRESTypePlugin *plugin)
{
    RTIOsapiHeap_freeStructure(plugin);
} 
