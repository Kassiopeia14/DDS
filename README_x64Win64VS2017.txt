...
data type CalculatorResponse from calculator.idl.
This example builds two applications, named calculator_publisher and
...
1. Launch Visual Studio in one of two ways:
        - By typing calculator-x64Win64VS2017.sln in the
          Command Prompt window.
        - By opening Visual Studio on your machine and then opening the
          calculator-x64Win64VS2017.sln file (in the
...
2. Select Build Solution from the Build menu. (You can also right-click
   calculator_publisher or calculator_subscriber and
...
To modify the data being sent: edit the calculator_publisher.cxx
file where it says 
...
1. Right-click calculator_publisher and choose Debug > Start new instance.
2. Right-click calculator_subscriber and choose Debug > Start new instance.
...
2. Run C:\Program Files\rti_connext_dds-6.1.1\bin\..\resource\scripts\rtisetenv_x64Win64VS2017.bat
...
> objs\x64Win64VS2017\calculator_publisher.exe -d <domain_id> -s <sample_count>
> objs\x64Win64VS2017\calculator_subscriber.exe -d <domain_id> -s <sample_count>
